...
namespace internal {
	...
	constexpr const uint16_t LEAD_OFFSET         = 0xD7C0u;       // LEAD_SURROGATE_MIN - (0x10000 >> 10)
	constexpr const uint32_t SURROGATE_OFFSET    = 0xFCA02400u;   // 0x10000u - (LEAD_SURROGATE_MIN << 10) - TRAIL_SURROGATE_MIN
...
#undef UTF8_CPP_INCREASE_AND_RETURN_ON_ERROR
	...
	// Byte order mark:
	constexpr const uint8_t bom[] = {0xEF, 0xBB, 0xBF};
