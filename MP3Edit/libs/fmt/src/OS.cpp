...
#ifdef _WIN32
  // Use 'GetFileSize()' instead of 'GetFileSizeEx()' for the case when 
  // _WIN32_WINNT is less than 0x0500 as is the case with some default MinGW 
  // builds. Both functions support large file sizes.
  DWORD  size_upper = 0;
...
void file::pipe(file& read_end, file& write_end) {
  // Close the descriptors first to make sure that assignments don't throw and 
  // there are no leaks:
  read_end.close();
  write_end.close();
  int fds[2] = {};
