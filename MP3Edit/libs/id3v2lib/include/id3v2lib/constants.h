...
#define ID3v23  1
#define ID3v24  2
//  ----  END OF TAG_HEADER CONSTANTS  ----


//  ----  START OF TAG_FRAME CONSTANTS  ----
#define ID3_FRAME                   10
